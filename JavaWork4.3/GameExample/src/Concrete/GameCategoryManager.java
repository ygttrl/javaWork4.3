...
public class GameCategoryManager implements GameCategoryService {
	...
	public void Add(GameCategory gameCategory) {
		...
		try {
			...
			log.LogMessage(gameCategory, "Baþarýlý");
		} catch (Exception e) {
			log.LogMessage(gameCategory, "Hatalý");
		}
	...
	public void Update(GameCategory gameCategory) {
		...
		try {
			System.out.println(gameCategory.getId()+" 'li Oyun Kategorisi Güncellendi.");
			log.LogMessage(gameCategory, "Baþarýlý");
		} catch (Exception e) {
			log.LogMessage(gameCategory, "Hatalý");
		}
	...
	public void Delete(GameCategory gameCategory) {
		...
		try {
			System.out.println(gameCategory.getId()+" 'li Oyun Kategorisi SÝLÝNDÝ.");
			log.LogMessage(gameCategory, "Baþarýlý");
		} catch (Exception e) {
			log.LogMessage(gameCategory, "Hatalý");
		}
