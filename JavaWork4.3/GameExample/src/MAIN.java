...
public class MAIN {
	...
	public static void main(String[] args) {
		...
		GameCategory category = new GameCategory(1,"Strateji Oyunlarý");
		...
		Discount discount = new Discount(1,"Yýl Sonu Ýndirimi",50);
		...
		System.out.println( "Ýndirimli fiyat :"+ saleManager.Calculate(sale));
